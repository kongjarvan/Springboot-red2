...
<div class="container">
	...
	<ul class="pagination">
		...
		<c:forEach var="i" begin="${paging.startPageNum}" end="${paging.lastPageNum}" step="1">
			<li class='page-item ${paging.currentPage == i-1 ? "active" : ""}'><a class="page-link" href="?page=${i-1 }">${i }</a>&nbsp;</li>
		</c:forEach>
	...
	<div style="background-color: 'grey';">
		...
		<h3>totalstartPageNum : ${paging.startPageNum}</h3>
		<h3>totalstartPageNum : ${paging.lastPageNum}</h3>
